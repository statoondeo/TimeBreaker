...
public class PredictionController : MonoBehaviour
{
	...
	private System.Tuple<Transform, PaddlePhysicController> PaddleController;
	...
	private void OnPaddlePoppedCallback(EventModelArg eventModelArg)
	{
		...
		PaddleController = new System.Tuple<Transform, PaddlePhysicController>(paddleController, fakePaddle.GetComponent<PaddlePhysicController>());
	}
